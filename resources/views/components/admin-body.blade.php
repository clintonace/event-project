                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                <h4 class="text-base mb-1 text-gray-600 dark:text-gray-400">Project
                                    Dashboard</h4>
                                <p class="font-normal text-sm text-gray-400 truncate dark:text-gray-500">New
                                    Task Assign</p>
                            </div>

                            <div>
                                <button class="text-gray-600 dark:text-gray-400 fc-dropdown"
                                    data-fc-type="dropdown" data-fc-placement="left-start" type="button">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="/a-assets/assets/images/users/avatar-1.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="/a-assets/assets/images/users/avatar-2.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                            </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="/a-assets/assets/images/users/avatar-3.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="/a-assets/assets/images/users/avatar-4.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                            </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="/a-assets/assets/images/users/avatar-5.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="/a-assets/assets/images/users/avatar-6.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                            </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="/a-assets/assets/images/users/avatar-7.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="/a-assets/assets/images/users/avatar-8.jpg"
                                        class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700"
                                        alt="friend">
                                </a>
                            </div>
                        ...
                        <div class="p-6" style="position: relative;">
                            ...
                            <div id="monthly-target" class="apex-charts my-8" data-colors="#0acf97,#3073F1"
                                ...
                                <div id="apexchartsxc7b9aei"
                                    ...
                                    style="width: 704px; height: 258.7px;"><svg id="SvgjsSvg1132"
                                        width="704" height="258.7" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g id="SvgjsG1134" class="apexcharts-inner apexcharts-graphical"
                                            ...
                                            <defs id="SvgjsDefs1133">
                                                ...
                                                <filter id="SvgjsFilter1146" filterUnits="userSpaceOnUse"
                                                    ...
                                                    <feComposite id="SvgjsFeComposite1148"
                                                        in="SvgjsFeFlood1147Out" in2="SourceAlpha"
                                                        operator="in" result="SvgjsFeComposite1148Out">
                                                    </feComposite>
                                                    <feOffset id="SvgjsFeOffset1149" dx="1" dy="1"
                                                        result="SvgjsFeOffset1149Out"
                                                        in="SvgjsFeComposite1148Out"></feOffset>
                                                    <feGaussianBlur id="SvgjsFeGaussianBlur1150"
                                                        stdDeviation="1 "
                                                        result="SvgjsFeGaussianBlur1150Out"
                                                        in="SvgjsFeOffset1149Out"></feGaussianBlur>
                                                    <feMerge id="SvgjsFeMerge1151"
                                                        result="SvgjsFeMerge1151Out" in="SourceGraphic">
                                                ...
                                                <filter id="SvgjsFilter1159" filterUnits="userSpaceOnUse"
                                                    ...
                                                    <feFlood id="SvgjsFeFlood1160" flood-color="#000000"
                                                        ...
                                                        in="SourceGraphic"></feFlood>
                                                    <feComposite id="SvgjsFeComposite1161"
                                                        in="SvgjsFeFlood1160Out" in2="SourceAlpha"
                                                        operator="in" result="SvgjsFeComposite1161Out">
                                                    </feComposite>
                                                    <feOffset id="SvgjsFeOffset1162" dx="1" dy="1"
                                                        result="SvgjsFeOffset1162Out"
                                                        in="SvgjsFeComposite1161Out"></feOffset>
                                                    <feGaussianBlur id="SvgjsFeGaussianBlur1163"
                                                        stdDeviation="1 "
                                                        result="SvgjsFeGaussianBlur1163Out"
                                                        in="SvgjsFeOffset1162Out"></feGaussianBlur>
                                                    <feMerge id="SvgjsFeMerge1164"
                                                        result="SvgjsFeMerge1164Out" in="SourceGraphic">
                                            ...
                                            <g id="SvgjsG1138" class="apexcharts-pie">
                                                <g id="SvgjsG1139" transform="translate(0, 0) scale(1)">
                                                    <circle id="SvgjsCircle1140" r="77.27073170731708"
                                                        cx="128" cy="128" fill="transparent"></circle>
                                                    <g id="SvgjsG1141" class="apexcharts-slices">
                                                        ...
                                                        <g id="SvgjsG1144" class="apexcharts-datalabels">
                                                            <text id="SvgjsText1145"
                                                                font-family="Helvetica, Arial, sans-serif"
                                                                x="209.27516623422903"
                                                                y="182.89019379918153" text-anchor="middle"
                                                        ...
                                                        <g id="SvgjsG1157" class="apexcharts-datalabels">
                                                            <text id="SvgjsText1158"
                                                                font-family="Helvetica, Arial, sans-serif"
                                            ...
                                            <line id="SvgjsLine1168" x1="0" y1="0" x2="256" y2="0"
                                                stroke="#b6b6b6" stroke-dasharray="0" stroke-width="1"
                                                class="apexcharts-ycrosshairs"></line>
                                            <line id="SvgjsLine1169" x1="0" y1="0" x2="256" y2="0"
                    ...
                    <div class="card">
                        <div class="p-6">
                            ...
                            <div dir="ltr" class="mt-2" style="position: relative;">
                                <div id="crm-project-statistics" class="apex-charts"
                                    data-colors="#cbdcfc,#3073F1" style="min-height: 365px;">
                                    <div id="apexcharts2kxfdjic"
                                        class="apexcharts-canvas apexcharts2kxfdjic apexcharts-theme-light"
                                        style="width: 704px; height: 350px;"><svg id="SvgjsSvg1001"
                                            width="704" height="350" xmlns="http://www.w3.org/2000/svg"
                                            version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns:svgjs="http://svgjs.com/svgjs" class="apexcharts-svg"
                                            xmlns:data="ApexChartsNS" transform="translate(0, 0)"
                                            style="background: transparent;">
                                                ...
                                                <div class="apexcharts-legend apexcharts-align-center position-bottom"
                                                    ...
                                                    <div class="apexcharts-legend-series" rel="2"
                                                        ...
                                                        style="margin: 2px 5px;"><span
                                                            ...
                                                            data:default-text="Working%20Hours"
                                                            data:collapsed="false"
                                            ...
                                            <g id="SvgjsG1003" class="apexcharts-inner apexcharts-graphical"
                                                ...
                                                <defs id="SvgjsDefs1002">
                                                    ...
                                                    <clipPath id="gridRectMask2kxfdjic">
                                                        <rect id="SvgjsRect1012" width="653.3125"
                                                            height="258.73" x="-3.5" y="-1.5" rx="0" ry="0"
                                                            opacity="1" stroke-width="0" stroke="none"
                                                            stroke-dasharray="0" fill="#fff"></rect>
                                                    </clipPath>
                                                    <clipPath id="gridRectMarkerMask2kxfdjic">
                                                        <rect id="SvgjsRect1013" width="650.3125"
                                                            height="259.73" x="-2" y="-2" rx="0" ry="0"
                                                            opacity="1" stroke-width="0" stroke="none"
                                                            stroke-dasharray="0" fill="#fff"></rect>
                                                    </clipPath>
                                                </defs>
                                                <rect id="SvgjsRect1011" width="8.9765625"
                                                    height="255.73000000000002" x="0" y="0" rx="0" ry="0"
                                                ...
                                                <g id="SvgjsG1057" class="apexcharts-xaxis"
                                                    ...
                                                    <g id="SvgjsG1058" class="apexcharts-xaxis-texts-g"
                                                        transform="translate(0, -4)"><text
                                                            id="SvgjsText1060"
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="35.90625" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="107.71875" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="179.53125" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="251.34375" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="323.15625" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="394.96875" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="466.78125" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="538.59375" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                            ...
                                                            font-family="Helvetica, Arial, sans-serif"
                                                            x="610.40625" y="284.73" text-anchor="middle"
                                                            dominant-baseline="auto" font-size="12px"
                                                            font-weight="400" fill="#373d3f"
                                                            class="apexcharts-text apexcharts-xaxis-label "
                                                            style="font-family: Helvetica, Arial, sans-serif;">
                                                ...
                                                <g id="SvgjsG1101" class="apexcharts-grid">
                                                    <g id="SvgjsG1102"
                                                        ...
                                                        <line id="SvgjsLine1114" x1="0" y1="0" x2="646.3125"
                                                            y2="0" stroke="#9ca3af20" stroke-dasharray="0"
                                                    ...
                                                    <line id="SvgjsLine1104" x1="0" y1="256.73" x2="0"
                                                        y2="262.73" stroke="#e0e0e0" stroke-dasharray="0"
                                                    ...
                                                    <rect id="SvgjsRect1120" width="646.3125"
                                                        height="51.146" x="0" y="0" rx="0" ry="0"
                                                        opacity="0.2" stroke-width="0" stroke="none"
                                                        stroke-dasharray="0" fill="transparent"
                                                        clip-path="url(#gridRectMask2kxfdjic)"
                                                        class="apexcharts-grid-row"></rect>
                                                    <rect id="SvgjsRect1121" width="646.3125"
                                                        height="51.146" x="0" y="51.146" rx="0" ry="0"
                                                        opacity="0.2" stroke-width="0" stroke="none"
                                                        stroke-dasharray="0" fill="transparent"
                                                        clip-path="url(#gridRectMask2kxfdjic)"
                                                        class="apexcharts-grid-row"></rect>
                                                    <rect id="SvgjsRect1122" width="646.3125"
                                                        height="51.146" x="0" y="102.292" rx="0" ry="0"
                                                        opacity="0.2" stroke-width="0" stroke="none"
                                                        stroke-dasharray="0" fill="transparent"
                                                        clip-path="url(#gridRectMask2kxfdjic)"
                                                        class="apexcharts-grid-row"></rect>
                                                    <rect id="SvgjsRect1123" width="646.3125"
                                                        height="51.146" x="0" y="153.438" rx="0" ry="0"
                                                        opacity="0.2" stroke-width="0" stroke="none"
                                                        stroke-dasharray="0" fill="transparent"
                                                        clip-path="url(#gridRectMask2kxfdjic)"
                                                        class="apexcharts-grid-row"></rect>
                                                    <rect id="SvgjsRect1124" width="646.3125"
                                                        height="51.146" x="0" y="204.584" rx="0" ry="0"
                                                        opacity="0.2" stroke-width="0" stroke="none"
                                                        stroke-dasharray="0" fill="transparent"
                                                        clip-path="url(#gridRectMask2kxfdjic)"
                                                        class="apexcharts-grid-row"></rect>
                                                    <line id="SvgjsLine1126" x1="0" y1="255.73000000000002"
                                                        x2="646.3125" y2="255.73000000000002"
                                                        stroke="transparent" stroke-dasharray="0"></line>
                                                    <line id="SvgjsLine1125" x1="0" y1="1" x2="0"
                                                        y2="255.73000000000002" stroke="transparent"
                                                ...
                                                <line id="SvgjsLine1127" x1="0" y1="0" x2="646.3125" y2="0"
                                                    stroke="#b6b6b6" stroke-dasharray="0" stroke-width="1"
                                                    class="apexcharts-ycrosshairs"></line>
                                                <line id="SvgjsLine1128" x1="0" y1="0" x2="646.3125" y2="0"
                                                    stroke-dasharray="0" stroke-width="0"
                                                    class="apexcharts-ycrosshairs-hidden"></line>
                                                <g id="SvgjsG1129" class="apexcharts-yaxis-annotations"></g>
                                                <g id="SvgjsG1130" class="apexcharts-xaxis-annotations"></g>
                                                <g id="SvgjsG1131" class="apexcharts-point-annotations"></g>
                                            </g>
                                            <g id="SvgjsG1087" class="apexcharts-yaxis" rel="0"
                                                transform="translate(17.6875, 0)">
                                                <g id="SvgjsG1088" class="apexcharts-yaxis-texts-g"><text
                                                        id="SvgjsText1089"
                                ...
                                <div class="resize-triggers">
                                    <div class="expand-trigger">
                                        <div style="width: 705px; height: 351px;">
        ...
        <div class="col-span-1">
            ...
            <div class="card p-6">
                ...
                <div class="flex w-full h-1 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700 ">
                    <div class="flex flex-col justify-center overflow-hidden bg-primary w-1/4"
                        ...
                        <div class="md:order-2 order-1" style="position: relative;">
                            <div id="project-overview-chart" class="apex-charts"
                                ...
                                <div id="apexcharts7r6a74iq"
                                    ...
                                    style="width: 344px; height: 328.7px;"><svg id="SvgjsSvg1170"
                                        width="344" height="328.7" xmlns="http://www.w3.org/2000/svg"
                                        version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        xmlns:svgjs="http://svgjs.com/svgjs" class="apexcharts-svg"
                                        xmlns:data="ApexChartsNS" transform="translate(0, 0)"
                                        style="background: transparent;">
                                        <g id="SvgjsG1172" class="apexcharts-inner apexcharts-graphical"
                                                    ...
                                                    <g id="SvgjsG1187">
                                                        ...
                                                        <g id="SvgjsG1189"
                                                            ...
                                                            style="opacity: 0;"><text id="SvgjsText1190"
                                                                font-family="Helvetica, Arial, sans-serif"
                                                                x="163" y="163" text-anchor="middle"
                                                                ...
                                                                id="SvgjsText1191"
                                                                font-family="Helvetica, Arial, sans-serif"
                                                                x="163" y="195" text-anchor="middle"
                                            ...
                                            <line id="SvgjsLine1200" x1="0" y1="0" x2="326" y2="0"
                                                stroke="#b6b6b6" stroke-dasharray="0" stroke-width="1"
                                                class="apexcharts-ycrosshairs"></line>
                                            <line id="SvgjsLine1201" x1="0" y1="0" x2="326" y2="0"
                                                stroke-dasharray="0" stroke-width="0"
                                                class="apexcharts-ycrosshairs-hidden"></line>
                                        </g>
                ...
                <div class="py-6">
                    <div class="px-6" data-simplebar="init" style="max-height: 304px;">
                        <div class="simplebar-wrapper" style="margin: 0px -24px;">
                            ...
                            <div class="simplebar-placeholder" style="width: auto; height: 467px;"></div>
                        </div>
                                            ...
                                            <div class="space-y-6">
                                                <div class="flex items-center">
                                                    <img class="me-3 rounded-full"
                                                        src="/a-assets/assets/images/users/avatar-1.jpg" width="40"
                                                ...
                                                <div class="flex items-center">
                                                    <img class="me-3 rounded-full"
                                                        src="/a-assets/assets/images/users/avatar-2.jpg" width="40"
                                                        alt="Generic placeholder image">
                                                    <div class="w-full overflow-hidden">
                                                        <h5 class="font-semibold"><a
                                                                href="javascript:void(0);"
                                                ...
                                                <div class="flex items-center">
                                                    <img class="me-3 rounded-full"
                                                        src="/a-assets/assets/images/users/avatar-3.jpg" width="40"
                                                        alt="Generic placeholder image">
                                                    <div class="w-full overflow-hidden">
                                                        <h5 class="font-semibold"><a
                                                                href="javascript:void(0);"
                                                ...
                                                <div class="flex items-center">
                                                    <img class="me-3 rounded-full"
                                                        src="/a-assets/assets/images/users/avatar-4.jpg" width="40"
                                                        alt="Generic placeholder image">
                                                    <div class="w-full overflow-hidden">
                                                        <h5 class="font-semibold"><a
                                                                href="javascript:void(0);"
                                                ...
                                                <div class="flex items-center">
                                                    <img class="me-3 rounded-full"
                                                        src="/a-assets/assets/images/users/avatar-5.jpg" width="40"
                                                        alt="Generic placeholder image">
                                                    <div class="w-full overflow-hidden">
                                                        <h5 class="font-semibold"><a
                                                                href="javascript:void(0);"
                                                ...
                                                <div class="flex items-center">
                                                    <img class="me-3 rounded-full"
                                                        src="/a-assets/assets/images/users/avatar-6.jpg" width="40"
                                                        alt="Generic placeholder image">
                                                    <div class="w-full overflow-hidden">
                                                        <h5 class="font-semibold"><a
                                                                href="javascript:void(0);"
