<header class="app-header flex items-center px-4 gap-3">
    ...
    <a href="index.html" class="logo-box">
        ...
        <div class="logo-light">
            <img src="/a-assets/assets/images/logo-light.png" class="logo-lg h-6" alt="Light logo">
            <img src="/a-assets/assets/images/logo-sm.png" class="logo-sm" alt="Small logo">
        </div>

        <!-- Dark Brand Logo -->
        <div class="logo-dark">
            <img src="/a-assets/assets/images/logo-dark.png" class="logo-lg h-6" alt="Dark logo">
            <img src="/a-assets/assets/images/logo-sm.png" class="logo-sm" alt="Small logo">
        </div>
    </a>

    <!-- Topbar Search Modal Button -->
    <button type="button" data-fc-type="modal" data-fc-target="topbar-search-modal"
    ...
    <div class="relative">
        <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button"
            ...
            <span class="flex items-center justify-center h-6 w-6">
                <img src="/a-assets/assets/images/flags/us.jpg" alt="user-image" class="h-4 w-6">
            </span>
        </button>
        <div
            ...
            <a href="javascript:void(0);"
                ...
                <img src="/a-assets/assets/images/flags/germany.jpg" alt="user-image" class="h-4">
            ...
            <a href="javascript:void(0);"
                class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                <img src="/a-assets/assets/images/flags/italy.jpg" alt="user-image" class="h-4">
            ...
            <a href="javascript:void(0);"
                class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                <img src="/a-assets/assets/images/flags/spain.jpg" alt="user-image" class="h-4">
            ...
            <a href="javascript:void(0);"
                class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                <img src="/a-assets/assets/images/flags/russia.jpg" alt="user-image" class="h-4">
    ...
    <div class="relative md:flex hidden">
        ...
        <div
            ...
            <div class="p-4 h-80" data-simplebar="init">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="flex-grow truncate ms-2">
                                                    <h5 class="text-sm font-semibold mb-1">Datacorp <small
                                                            class="font-normal text-gray-500 ms-1">1 min
                                                            ago</small></h5>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="flex-grow truncate ms-2">
                                                    <h5 class="text-sm font-semibold mb-1">Admin <small
                                                            class="font-normal text-gray-500 ms-1">1 hr
                                                            ago</small></h5>
                                    ...
                                    <a href="javascript:void(0);" class="block mb-4">
                                        <div class="card-body">
                                            <div class="flex items-center">
                                                ...
                                                <div class="flex-grow truncate ms-2">
                                                    <h5 class="text-sm font-semibold mb-1">Cristina Pride
                                                        <small class="font-normal text-gray-500 ms-1">1 day
                                                            ago</small></h5>
                                    ...
                                    <a href="javascript:void(0);" class="block">
                                        <div class="card-body">
                                            <div class="flex items-center">
                                                ...
                                                <div class="flex-grow truncate ms-2">
                                                    <h5 class="text-sm font-semibold mb-1">Karen Robinson
                                                    </h5>
    ...
    <div class="relative">
        <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button"
            class="nav-link fc-dropdown">
            <img src="/a-assets/assets/images/users/user-6.jpg" alt="user-image" class="rounded-full h-10">
        </button>
        <div
